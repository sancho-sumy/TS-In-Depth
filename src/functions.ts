...
export function getBooksTitleByCategory(inputCategory: Category = Category.JavaScript): string[] {
...
export function callTotalPages(): void {
    const data = <const>[
...
export function getBooksByCategory(category: Category, callback: LibMgrCallback): void {
    setTimeout(() => {
        try {
            const titles = getBooksTitleByCategory(category);
            if (titles.length > 0) {
